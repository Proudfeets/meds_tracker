class PrescriptionSerializer < ActiveModel::Serializer
  attributes :user_prescriptions, :id, :user, :medication, :medication_brand,
    :medication_generic, :dosage, :frequency_number, :frequency_period,
    :special_instructions, :prescribed_by
